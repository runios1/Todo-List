...
function colorButton(color, colorPicker, colorContainer, project) {
  ...
  domElement.addEventListener("click", () => {
    ...
    project.color = color;
    _project__WEBPACK_IMPORTED_MODULE_0__.projects.updateProjectsStorage();
  });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (colorPickerClickHandler);
...
const sortIcon =
  '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>reverse-sort</title><path d="M14,8H11V14H6V8H3L8.5,2L14,8M15.5,22L21,16H18V10H13V16H10L15.5,22Z" /></svg>';
...
/* harmony export */   displayTodayCard: () => (/* binding */ displayTodayCard)
/* harmony export */ });
...
/* harmony import */ var _taskFormDOM__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./taskFormDOM */ "./src/taskFormDOM.js");
...
function calculateTime(time) {
  if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(time)) return "Overdue";
  if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(time)) return (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(time, "k:mm");
  if ((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(time)) return `${(0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(time, "k:mm")}, Tommorow`;
  if ((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(time)) return (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(time, "EEEE");
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(time, "MMM do, yyyy");
}

function taskClickHandler(task) {
  (0,_taskFormDOM__WEBPACK_IMPORTED_MODULE_0__.changeFormToEditTask)(task);
...
function makeSortSelect(main, project) {
  ...
  sortButton.innerHTML = _icons__WEBPACK_IMPORTED_MODULE_1__.sortIcon;
...
function displayTodayCard() {
  ...
  const taskList = (0,_today__WEBPACK_IMPORTED_MODULE_2__["default"])();

  displayCard("var(--teal)", "Today", taskList);
}

document.querySelector("dialog.task").addEventListener("close", () => {
  if (_selectedProject__WEBPACK_IMPORTED_MODULE_3__.selectedProject) {
    displayTasks(_selectedProject__WEBPACK_IMPORTED_MODULE_3__.selectedProject.getSortedTasks());
  } else {
    displayTasks((0,_today__WEBPACK_IMPORTED_MODULE_2__["default"])());
  }
});
...
function selectProject(project) {
  ...
  (0,_selectedProject__WEBPACK_IMPORTED_MODULE_1__.toggleSelectedProject)(project);
...
function deselectProject(project) {
  ...
  (0,_selectedProject__WEBPACK_IMPORTED_MODULE_1__.toggleSelectedProject)(project);
  (0,_mainDOM__WEBPACK_IMPORTED_MODULE_3__.displayProjectCard)(null);
...
function deleteClickHandler(project) {
  if ((0,_selectedProject__WEBPACK_IMPORTED_MODULE_1__.isSelectedProject)(project)) deselectProject(project);
  _project__WEBPACK_IMPORTED_MODULE_0__.projects.deleteProject(project);
...
function displayProjects() {
  ...
  container.innerHTML = "";
  _project__WEBPACK_IMPORTED_MODULE_0__.projects.getProjects().forEach((project) => {
    ...
    color.addEventListener("click", (event) =>
      (0,_colorPickerDOM__WEBPACK_IMPORTED_MODULE_2__["default"])(event, project),
    );
    ...
    deleteButton.innerHTML = _icons__WEBPACK_IMPORTED_MODULE_4__.deleteIcon;
...
function validateProjectForm(name) {
  ...
  if (_project__WEBPACK_IMPORTED_MODULE_0__.projects.isNameDuplicate(name)) {
...
function getProjectDialogForm() {
  ...
  function formSubmitHandler() {
    if (validateProjectForm(nameInput.value)) {
      ...
      _project__WEBPACK_IMPORTED_MODULE_0__.projects.addProject(project);
...
function displayToday(event) {
  ...
  if (_selectedProject__WEBPACK_IMPORTED_MODULE_1__.selectedProject) deselectProject(_selectedProject__WEBPACK_IMPORTED_MODULE_1__.selectedProject);
  (0,_mainDOM__WEBPACK_IMPORTED_MODULE_3__.displayTodayCard)();
}
...
function getProjectsFromStorage() {
  _project__WEBPACK_IMPORTED_MODULE_0__.projects.getProjectArrayFromStorage();
  document.dispatchEvent(projectsUpdatedEvent);
  _project__WEBPACK_IMPORTED_MODULE_0__.projects
    .getProjects()
    .forEach((project) =>
      project.DOMElement.addEventListener("click", () =>
        selectProject(project),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   isSelectedProject: () => (/* binding */ isSelectedProject),
...
/* harmony import */ var _taskProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./taskProperty */ "./src/taskProperty.js");
...
class Task {
  ...
  constructor(
    ...
    this.#name = new _taskProperty__WEBPACK_IMPORTED_MODULE_0__["default"]("name", nameVal, "text");
    this.#time = new _taskProperty__WEBPACK_IMPORTED_MODULE_0__["default"]("time", (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(timeVal), "datetime-local");
    this.#description = new _taskProperty__WEBPACK_IMPORTED_MODULE_0__["default"]("description", descriptionVal, "N/A");
    this.#priority = new _taskProperty__WEBPACK_IMPORTED_MODULE_0__["default"]("priority", priorityVal, "number");
    this.project = new _taskProperty__WEBPACK_IMPORTED_MODULE_0__["default"]("", project, "N/A");
  }
   ...
   */
  set time(newTime) {
    this.#time.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(newTime);
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   changeFormToEditTask: () => (/* binding */ changeFormToEditTask),
/* harmony export */   newTaskSubmitHandler: () => (/* binding */ newTaskSubmitHandler)
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/format/index.js");
/* harmony import */ var _selectedProject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./selectedProject */ "./src/selectedProject.js");
...
function newTaskSubmitHandler() {
  if (_selectedProject__WEBPACK_IMPORTED_MODULE_0__.selectedProject) {
    const newTask = new _task__WEBPACK_IMPORTED_MODULE_1__.Task(
      _selectedProject__WEBPACK_IMPORTED_MODULE_0__.selectedProject,
      document.querySelector("#name").value,
      document.querySelector("#time").value,
      document.querySelector("#description").value,
      document.querySelector("#priority").value,
    );
    _selectedProject__WEBPACK_IMPORTED_MODULE_0__.selectedProject.addTask(newTask);
  } else {
...
function createForm() {
  ...
  priority.max = _task__WEBPACK_IMPORTED_MODULE_1__.maxPriority;
  priority.min = _task__WEBPACK_IMPORTED_MODULE_1__.minPriority;
...
function changeFormToEditTask(task) {
  ...
  if (!Number.isNaN(task.time.value.valueOf())) {
    document.getElementById("time").value = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(
      task.time.value,
      "yyyy-MM-dd HH:mm",
    );
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TaskProperty);
...
function getTodaysTasks() {
  ...
  _project__WEBPACK_IMPORTED_MODULE_0__.projects.getProjects().forEach((project) => {
    project.getTasks("time").every((task) => {
      if ((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(task.time.value)) {
        taskList.push(task);
      } else if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.time.value)) return false; // breaks
      return true;
    });
  });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getTodaysTasks);
